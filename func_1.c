...
/**
 * print_unsigned - This prototype will output an unsigned number
...
/**
 * print_octal - This outputs an unsigned number in octal notation
 * @list: List of args
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
...
/**
 * print_hexadecimal - This outputs an unsigned number in hexadecimal notation
 * @list: list of args
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
...
/**
 * print_hexa_upper - Output an unsigned number in upper hex notation
 * @list: list of args
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
