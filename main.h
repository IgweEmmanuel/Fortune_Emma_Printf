...
#define F_PLUS 2     /* Flag for force sign */
#define F_ZERO 4     /* Flag for zero-padding */
#define F_HASH 8     /* Flag for alternate form (hexadecimal and octal) */
#define F_SPACE 16   /* Flag for space before positive numbers */
...
/**
 * struct fmt - Structure to represent format specifier and associated function
 *
